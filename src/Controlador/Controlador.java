    ...
    public void Control(){
        ...
        while(control) {
            ...
            switch (opcion) {
                ...
                case 2:
                    String nameUsuario;
                    boolean iniciarSesion = listaUsuarios.verificarCuenta(nameUsuario = vistaUsuario.datoInicioSesion(),
                            vistaUsuario.claveInicioSesion());
                    if(iniciarSesion) {
                        boolean salir = false;
                        while (!salir) {
                            int opcionUsuario = vistaUsuario.interfazUsuario(nameUsuario);
                        ...
                        vistaUsuario.imprimir("Usuario o contraseña inválidos.");
                    }
                    break;
                case 3:
                    boolean cierre = true;
                    nameUsuario = "";
                    iniciarSesion = listaUsuarios.verificarCuenta(nameUsuario = vistaUsuario.datoInicioSesion(),
                            vistaUsuario.claveInicioSesion());
                    while (iniciarSesion) {
                        boolean salir = false;
                        while (!salir) {
